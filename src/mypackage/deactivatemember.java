...
public class deactivatemember extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{  
			...
			grp.close();
			String e=null;
			String q13="Select email from group_member where gname=? and member_name =?";
			PreparedStatement s13=(PreparedStatement) con.prepareStatement(q13);
			s13.setString(1, groupname);
			s13.setString(2,name);
			ResultSet grp3=s13.executeQuery();
			while(grp3.next()){
				e=grp3.getString("email");
			}
			grp3.close();
			...
			String q21="DELETE FROM tran_summary WHERE email=?";
