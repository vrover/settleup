...
/**
 * Servlet implementation class declineresume
 */
@WebServlet("/declineresume")
public class declineresume extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{  
			...
			String q2="Update group_member set status='OL' where gname=? and member_name=?";
